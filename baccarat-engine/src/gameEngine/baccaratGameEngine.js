...
import BaccaratResultsEngine, { valueForCard } from "../baccaratResultsEngine";
...
class BaccaratGameEngine {
  ...
  burnCards() {
    ...
    let burnCardValue = valueForCard(burnCard);
  ...
  dealGame() {
    ...
    if (bankerCardsValue > 7 || playerCardsValue > 7) {
      ...
      let player3rdCardValue = valueForCard(player3rdCard);
...
export default BaccaratGameEngine;
