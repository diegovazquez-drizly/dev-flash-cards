...
export const DefaultSuits = Card.DefaultSuits;
export const DefaultValues = Card.DefaultValues;

export const StandardSuitUnicodeStrings = Card.StandardSuitUnicodeStrings;
